...
Version  : 24.12.2
Release  : 79
URL      : https://download.kde.org/stable/release-service/24.12.2/src/kde-dev-utils-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kde-dev-utils-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kde-dev-utils-24.12.2.tar.xz.sig
...
%setup -q -n kde-dev-utils-24.12.2
cd %{_builddir}/kde-dev-utils-24.12.2
pushd ..
cp -a kde-dev-utils-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738979994
mkdir -p clr-build
pushd clr-build
