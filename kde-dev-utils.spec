...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kde-dev-utils-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kde-dev-utils-24.12.3.tar.xz.sig
...
%setup -q -n kde-dev-utils-24.12.3
cd %{_builddir}/kde-dev-utils-24.12.3
pushd ..
cp -a kde-dev-utils-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742489530
mkdir -p clr-build
pushd clr-build
