...
Version  : 22.04.1
Release  : 40
URL      : https://download.kde.org/stable/release-service/22.04.1/src/kde-dev-utils-22.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.1/src/kde-dev-utils-22.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.1/src/kde-dev-utils-22.04.1.tar.xz.sig
...
%prep
%setup -q -n kde-dev-utils-22.04.1
cd %{_builddir}/kde-dev-utils-22.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652655557
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kde-dev-utils-22.04.1/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kde-dev-utils/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kde-dev-utils-22.04.1/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kde-dev-utils/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/kde-dev-utils-22.04.1/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kde-dev-utils/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kde-dev-utils-22.04.1/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kde-dev-utils/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
