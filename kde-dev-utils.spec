...
Source0  : https://download.kde.org/stable/release-service/20.04.0/src/kde-dev-utils-20.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.0/src/kde-dev-utils-20.04.0.tar.xz.sig
...
%prep
%setup -q -n kde-dev-utils-20.04.0
cd %{_builddir}/kde-dev-utils-20.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587679214
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kde-dev-utils-20.04.0/COPYING %{buildroot}/usr/share/package-licenses/kde-dev-utils/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/kde-dev-utils-20.04.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kde-dev-utils/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd clr-build
%make_install
popd
%find_lang kuiviewer
